...
REQUIRED_FILES = (
    ...
    "apps/api/v1/http.py",
    "apps/api/v1/money.py",
    "apps/api/v1/views/health.py",
    "apps/api/v1/views/public.py",
    "apps/api/v1/serializers/public.py",
    "apps/api/tests/test_v1_http.py",
    "apps/api/tests/test_v1_money.py",
    "apps/api/tests/test_v1_default_permissions.py",
    "templates/base.html",
