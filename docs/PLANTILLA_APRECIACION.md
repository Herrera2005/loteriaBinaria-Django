...
Complete esta plantilla con sus propias palabras después de revisar la propuesta de alcance del Taller #3.

No copie literalmente la respuesta de la IA. Use las preguntas guía para identificar:

1. qué partes considera correctas o útiles;
2. qué partes considera exageradas o innecesarias;
3. qué ajustes realizaría para adaptar la propuesta al tiempo, la rúbrica y el alcance real del taller.

La apreciación debe referirse al Taller #3 de Lotería Binaria con Django, considerando:

- SQLite en la primera fase;
- MySQL en la segunda fase;
- Bootstrap 5.3;
- cinco apps canónicas;
- CRUD evaluable en `accounts`, `vendors` y `lottery`;
- login y roles como mejora adicional;
...
- ¿Qué partes de la propuesta coinciden con los requisitos del Taller #3?
- ¿Qué decisiones ayudan a organizar mejor el desarrollo?
- ¿Por qué resulta útil comenzar con SQLite antes de pasar a MySQL?
- ¿Por qué es adecuado usar Bootstrap 5.3 como framework principal?
- ¿Qué ventaja tiene dividir el sistema en cinco apps por módulo?
- ¿Por qué `accounts`, `vendors` y `lottery` son apropiadas para demostrar los tres CRUD?
- ¿Qué utilidad tiene implementar login y roles como mejora adicional?
- ¿Qué reglas ayudan a evitar pérdida de datos o eliminación de información histórica?
- ¿Qué elementos de evidencia serían útiles para demostrar el trabajo realizado?
- ¿Qué partes de la propuesta facilitarían explicar el proyecto durante una evaluación?
...
- ¿Qué partes de la propuesta podrían ser demasiado amplias para el tiempo disponible?
- ¿Qué funciones no son necesarias para aprobar el taller?
- ¿Qué módulos o flujos podrían dejarse solamente como consulta?
- ¿Qué funciones financieras podrían posponerse?
- ¿Es necesario implementar todos los servicios de negocio del MVP?
- ¿Qué características pertenecen más a una aplicación empresarial que a un taller académico?
- ¿Qué pruebas podrían ser demasiado avanzadas para esta entrega?
- ¿Qué funciones del ZIP legado no deberían trasladarse al proyecto Django?
- ¿Qué elementos podrían aumentar la complejidad sin aportar directamente a la rúbrica?
- ¿Qué ampliaciones conviene mantener como trabajo futuro?
...
- ¿Qué funciones conservaría como mínimo obligatorio?
- ¿Qué funciones movería a una fase posterior?
- ¿Cómo reduciría el alcance sin incumplir la rúbrica?
- ¿Qué CRUD priorizaría primero y por qué?
- ¿En qué orden desarrollaría `accounts`, `vendors` y `lottery`?
- ¿Qué partes de `core` y `finance` dejaría solamente como apoyo?
- ¿Qué pantallas del ZIP conservaría como referencia visual?
- ¿Qué reglas antiguas eliminaría o corregiría?
- ¿Qué evidencias considera indispensables para la entrega?
- ¿Qué cambios haría para asegurar que el proyecto pueda terminarse y probarse a tiempo?
...
- [ ] La apreciación está escrita con palabras propias.
- [ ] Se identificaron aspectos correctos o útiles.
- [ ] Se identificaron aspectos exagerados o innecesarios.
- [ ] Se propusieron ajustes concretos.
- [ ] Se explicó por qué se priorizan tres CRUD.
- [ ] Se explicó por qué se usa Bootstrap 5.3.
- [ ] Se explicó la secuencia SQLite → MySQL.
- [ ] Se mencionó login y roles como mejora adicional.
- [ ] Se diferenciaron funciones obligatorias y ampliaciones futuras.
- [ ] Se agregó nombre y fecha.
